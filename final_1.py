...
ELEVENLABS_API_KEY = "sk_e1ec4b1ce31126c85ee728706b2f3526b4164a834f8b2e66"  
...
KNOWN_WIDTHS_CUSTOM = {
    "AIR_COMPRESSOR": 50, "BAG": 40, "BAMBULAB_3D_PRINTER": 45, "BLACK_MARKER": 2,
    "BLUE_ROBOTARM": 30, "BOOK": 15, "BOTTLE": 7, "BnR_TOOLKIT": 35,
    "Chair": 50, "DOBOT_MAGICIAN": 40, "DUSTBIN": 45,
    "ELEGOO Mercury XS Cure Station": 50,
    "ELEGOO Mercury XS Wash Station": 50,
    "ELGO_INFINITY_3D_PRINTER_GREEN": 50, "ENDERMAX_3D_PRINTER": 50,
    "ENDER_3D_PRINTER": 50, "FIRE_EXTINGUISHER": 25, "FLASHFORGE_3D_PRINTER": 55,
    "HP_MONITOR": 50, "JANATICS_Modular Manufacturing System": 60, "LAPTOP": 30,
    "MARKER": 2, "MOBILE_PHONE": 7, "NOTICE_BOARD": 150, "PODIUM_STAND": 100,
    "PROJECTOR_REMOTE": 10, "SMART_MONITOR": 55, "STUDENT_TABLE": 120,
    "TURTLEBOT_MINI": 40, "WATCH": 5, "WATER_PURIFIER": 60,
    "X-PLUS_QIDI_3D_PRINTER": 55
}
    ...
    try:
        ...
        with Image.open(IMAGE_SAVE_PATH) as img:
            response = model.generate_content([
                "In 3-4 short lines, describe the indoor surroundings. Mention people, objects like podiums or furniture, and directions briefly to help with safe navigation", img
            ])
...
speak("System ready. Press button one for detection or button two for scene description.")
